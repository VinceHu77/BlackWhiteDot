extends Node
class_name WuziqiEatFlow

signal state_changed(state: int)

var config: WuziqiEatCfg
var game_state: WuziqiEatState
var chess_board: WuziqiEatBoard = null
var game_hud: WuziqiEatHUD = null
var mode_bus: WuziqiEatBus = null

func _init(cfg: WuziqiEatCfg, bus: WuziqiEatBus = null) -> void:
	config = cfg
	game_state = WuziqiEatState.new(cfg)
	mode_bus = bus

func bind(board: WuziqiEatBoard, hud: WuziqiEatHUD) -> void:
	chess_board = board
	game_hud = hud
...
func _on_back_to_menu() -> void:
	game_state.current_state = WuziqiEatCfg.GameState.MENU
	if mode_bus:
...
func get_game_state() -> WuziqiEatState:
	return game_state
